...
module OpenapiClient
  class User
    ...
    def valid?
      ...
      role_validator = EnumAttributeValidator.new('String', ["engineer", "marketer", "product_manager", "executive"])
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["engineer", "marketer", "product_manager", "executive"])
    ...
    def hash
      [id, email, first_name, last_name, role, created_at, updated_at].hash
    end
